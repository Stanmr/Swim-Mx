...
public final class CargosWindow extends Window {
    ...
    public static void open(final Movie movie, final Date startTime,
        ...
        Window w = new CargosWindow(movie, startTime, endTime);
