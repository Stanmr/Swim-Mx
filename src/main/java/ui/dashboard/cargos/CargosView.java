...
import UI.dashboard.component.MovieDetailsWindow;
import UI.dashboard.domain.Transaction;
import UI.dashboard.event.DashboardEventBus;
import UI.dashboard.event.DashboardEvent.BrowserResizeEvent;
import UI.dashboard.event.DashboardEvent.TransactionReportEvent;
import UI.dashboard.view.DashboardViewType;

@SuppressWarnings({ "serial", "unchecked" })
public final class CargosView extends VerticalLayout implements View {

    private final Table table;
    private Button createReport;
    
    private static final String[] DEFAULT_COLLAPSIBLE = { "id_cargo","cargo","descripcion"};
    ...
    private Button buildCreateReport() {
        final Button createReport = new Button("Create Cargo");
        createReport
                .setDescription("Crear un nuevo cargo");
    ...
    private Table buildTable() {
        ...
        //table.setVisibleColumns("id_cargo", "cargo", "descripcion");
        //table.setColumnHeaders("ID", "Cargo", "Descripción");
...
//                                .getTotalSum()));
    ...
    void createNewReportFromSelection() {
    		Notification.show("Abrir el cargo");
    }
